...
რამდენიმე ეტაპიანი *Sanity Check* ჩავატარე იმისათვის, რომ დავრწმუნებულიყავი `TwoLayerFC` მოდელის იმპლემენტაციის სისწორეში. *Sanity Check*-ის დროს განსხვავებული მიდგომები მოვცადე და  თითოეული მიდგომა გამოვყავი ცალკე ნაწილად.
...
![alt text](./can_overfit_tiny_data.png)
...
![alt text](./can_overfit_tiny_data_2.png)
...
![alt text](./weights_init_tiny_weights.png)
...
![alt text](./weights_init_tiny_weights_2.png)
...
![alt text](./weights_init_tiny_weights_mean_std.png)
...
![alt text](./weights_init_large_weights.png)
...
![alt text](./weights_init_large_weights_2.png)
...
![alt text](./weights_init_large_weights_3.png)
...
![alt text](./weights_init_good_weights.png)
...
![alt text](./weights_init_good_weights_2.png)

აქ თითქმის ნორმალური განაწილება აქვს ყველა layer-ს რაც უფრო სიღრმეში მივდივართ.
